...
INSERT INTO Event (EventID, OrganizationID, EventName, EventDescription, EventType, EventDate, EventTime, NumMaxVolunteers, RSVPs) VALUES
    (1, 1, 'Charity1 Event Name', 'Charity1 Event Description.', 'Donation', '2024-11-01', '10:00:00', 50, 30),
    (2, 2, 'Charity2 Event Name', 'Charity2 Event Description.', 'Volunteer', '2024-11-02-', '09:00:00', 20, 15);
...
INSERT INTO SupplyRequest (RequestID, OrganizationID, ItemName, Quantity, Description, Location) VALUES
    (1, 1, 'Canned Food', 100, 'Canned items needed.', '123 Main St, Seattle, WA'),
    (2, 2, 'Trash Bags', 50, 'Trash bags for garbage.', '456 Elm St, Austin, TX');
